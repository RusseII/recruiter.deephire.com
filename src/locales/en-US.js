export default {
  ...
  'menu.Candidates.Short Lists': 'Short Lists',
  ...
  'menu.form': 'Interviews',
  'menu.form.basicform': 'Basic Form',
  'menu.form.createinterview': 'Create Interview',
  'menu.form.createinterview.info': 'Create',
  'menu.form.createinterview.confirm': 'Step Form(confirm transfer information)',
  'menu.form.createinterview.result': 'Interview Created',
  'menu.form.viewInterview': 'View Interviews',
  'menu.list': 'Candidates',
  'menu.list.searchtable': 'View Candidates',
  ...
  'app.analysis.total-sales': 'Total Interviews Completed',
  'app.analysis.day-sales': 'Completed Today',
  'app.analysis.visits': 'ShortList Views',
  'app.analysis.visits-trend': 'ShortList Views Trend',
  'app.analysis.visits-ranking': 'ShortList Views Ranking',
  'app.analysis.day-visits': 'Most Recent: Lisa Hale',
  'app.analysis.week': 'Week Ratio',
  'app.analysis.day': 'Day Ratio',
  'app.analysis.payments': 'Waiting on Client Feedback',
  'app.analysis.conversion-rate': 'Most Days: Bill Ratcliffe',
  'app.analysis.operational-effect': 'Interview Completion Percentage',
